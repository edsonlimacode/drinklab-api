...
public class GlobalHandleExceptions extends ResponseEntityExceptionHandler {
        ...
        public ResponseEntity<?> handleGlobalException(Exception ex, WebRequest request) {
                ...
                return super.handleExceptionInternal(ex, problemDetails, new HttpHeaders(), internalServerError,
                                request);
        ...
        public ResponseEntity<?> handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException ex) {
                ...
                String detail = String.format(
                                "O parâmetro %s, recebeu o valor '%s' que é inválido, informe um tipo compatível requerido '%s'",
        ...
        protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex,
                ...
                String errorMessage = String.format("Nenhuma uri corresponde ao metodo %s, para este recurso",
                                ex.getMethod());
        ...
        protected ResponseEntity<Object> handleNoResourceFoundException(NoResourceFoundException ex,
                ...
                String errorMessage = String.format("Recurso não encontrado: %s, para o método: %s",
                                ex.getResourcePath(),
                                ex.getHttpMethod());
        ...
        protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
                ...
                ProblemDetails problemDetails = getProblemDetails(badRequest,
                                "Corpo da requisição inválido, verique os dados enviados e tente novamente")
                                .build();
        ...
        private ResponseEntity<Object> handleInvalidFormatException(InvalidFormatException ex, HttpStatus badRequest) {
                ...
                String detail = String.format(
                                "A propriedade '%s' recebeu o valor '%s', que é de um tipo inválido. Corrija para um valor compatível com o tipo numérico %s.",
        ...
        protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
                ...
                List<ProblemDetails.Field> fieldList = ex.getBindingResult().getFieldErrors().stream()
                                .map(fieldError -> {

                                        String message = this.messageSource.getMessage(fieldError,
                ...
                ProblemDetails problemDetails = getProblemDetails(badRequest,
                                "Um ou mais campos estão inválidos, verique os campos e tente novamente")
                                .fields(fieldList)
                                .build();
